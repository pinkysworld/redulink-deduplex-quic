...
- logs:warm-update-like: best rsync-block-reuse (fixed) multiplier=72.694, savings=0.986
...
- updates:warm-update-like: best rsync-block-reuse (fixed) multiplier=63.300, savings=0.984

...
async def run_point(*, missing_every: int, blocks: int) -> dict[str, Any]:
    ...
    return {
        ...
        "tls_exporter_live": bool(stats["tls_exporter_live"]),
        "tls_exporter_outputs_match": bool(stats["tls_exporter_outputs_match"]),
        "tls_exporter_bridge": str(stats["tls_exporter_bridge"]),

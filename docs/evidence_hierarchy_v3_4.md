...
| Measured userspace path emulation (Sec. 10) | Competing-flow completion, queueing delay, and encoded-rate fairness on an emulated rate/RTT grid | Kernel tc/netem, Mininet, or Internet-path behavior |

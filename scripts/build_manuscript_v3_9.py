...
OUT = ROOT/'paper/submission/ReduLink_journal_ready_v3_9.docx'
...
"[15] M. Nguyen, 'ReduLink artifact and reproducibility package,' tagged release v3.9-journal-submission, GitHub, 2026. https://github.com/pinkysworld/redulink-deduplex-quic/releases/tag/v3.9-journal-submission",
...
doc.core_properties.comments='ReduLink journal-ready v3.9 manuscript; ORCID: 0000-0001-6834-4422; University of the People'
doc.save(OUT)
print('saved', OUT)

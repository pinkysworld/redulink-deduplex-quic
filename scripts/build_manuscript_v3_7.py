...
OUT = ROOT/'paper/submission/ReduLink_journal_ready_v3_7.docx'
...
tcap(doc,'Table 20. Measured full-duplex shared-bottleneck path emulation: mean completion time (ms, +/- s.d.) for competing raw and ReduLink flows on byte-stable demo bytes (five rounds) and real Redis-layered bytes (three rounds).')
...
"[15] M. Nguyen, 'ReduLink artifact and reproducibility package,' tagged release v3.7-journal-submission, GitHub, 2026. https://github.com/pinkysworld/redulink-deduplex-quic/releases/tag/v3.7-journal-submission",
...
doc.core_properties.comments='ReduLink journal-ready v3.7 manuscript; ORCID: 0000-0001-6834-4422; University of the People'
doc.save(OUT)
print('saved', OUT)

...
OUT = ROOT/'paper/submission/ReduLink_journal_ready_v2_7.docx'
...
heading(doc, '6.1 External Public Source Releases', 2)
rows=[]
for r in ext_public:
...
heading(doc, '6.2 Object-Aligned Public Release Transfers', 2)
rows=[]
for r in ext_obj:
...
try:
    ...
    para(doc, 'Figure 1. Public source releases evaluated as object-aligned transfer workloads.', size=9)
except Exception:
    pass

heading(doc, '6.3 Layer-Like External-Positive Case', 2)
r=ext_pos[0]
...
heading(doc, '6.4 Block-Size Sensitivity', 2)
...
try:
    ...
    doc.paragraphs[-1].alignment = WD_ALIGN_PARAGRAPH.CENTER
    para(doc, 'Figure 2. Native aioquic stream mapping on positive and negative workloads.', size=9)
except Exception:
    pass
...
"[15] M. Nguyen, 'ReduLink artifact and reproducibility package,' GitHub repository, 2026.",
...
"[18] J. B. P. et al., 'aioquic: QUIC and HTTP/3 implementation in Python,' software repository, version 1.3.0, accessed June 2026."
]
for ref in refs:
...
doc.core_properties.comments = 'ReduLink journal-ready v2.7 manuscript; ORCID: 0000-0001-6834-4422; University of the People'
doc.save(OUT)
print(OUT)

...
OUT = ROOT/'paper/submission/ReduLink_journal_ready_v3_3.docx'
...
doc.core_properties.comments='ReduLink journal-ready v3.3 manuscript; ORCID: 0000-0001-6834-4422; University of the People'
doc.save(OUT)
print('saved', OUT)

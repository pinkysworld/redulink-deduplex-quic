...
OUT = ROOT/'paper/submission/ReduLink_journal_ready_v3_4.docx'
...
tcap(doc,'Table 15. Payload scaling of the native aioquic stream mapping.')
...
doc.core_properties.comments='ReduLink journal-ready v3.4 manuscript; ORCID: 0000-0001-6834-4422; University of the People'
doc.save(OUT)
print('saved', OUT)
